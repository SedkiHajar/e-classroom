    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/School1/EspaceAdmin/login.php">ADMIN</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/School1/EspaceProf/login.php">PROFESSEUR</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/School1/EspaceEtudiant/login.php">ETUDIANT</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/School1/EspaceParent/login.php">PARENT</a>
          </li>
