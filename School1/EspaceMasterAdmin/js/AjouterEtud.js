...
function AjouterAdmin() {
  ...
  var i;
for (i = 0; i <(nbrContact-1); i++) {
 document.getElementById("AjoutDeform").innerHTML+='<hr class="sidebar-divider">'+'<h3 class=" font-weight-bold text-info text-center shadow  titre">ADMIN NUMERO : '+(i+2)+' </h3>'+cont;
