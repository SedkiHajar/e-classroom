<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT * FROM masteradmin WHERE mailM = '$mail' and mdpM = '$password'";
...
<head>
  ...
  <title>Sing In Master Admin </title>
...
<div class="loginbox ">
      ...
      <h1>Espace Master Admin</h1>
      <form class="form-signin" action="" method="POST">
        <div class="textbox">
            <i class="fas fa-user" aria-hidden="true"></i>
                <input type="email" id="inputEmail" name="email" placeholder="Saisir votre E-mail" required autofocus="">
        </div>
        <div class="textbox">
    ...
    <div class="row">
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            <h5 class="card-title text-center">Bienvenue dans l'espace Master Admin </h5>
            <form class="form-signin" action="" method="POST">
