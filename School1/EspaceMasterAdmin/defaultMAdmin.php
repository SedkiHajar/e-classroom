  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="/School/EspaceMasterAdmin/welcome.php">
      ...
      <li class="nav-item">
        ...
        <div id="collapseProf" class="collapse" aria-labelledby="headingProf" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="/School/EspaceMasterAdmin/AjouterMadmin.php">Ajouter les Admin</a>
            <a class="collapse-item" href="/School/EspaceMasterAdmin/gestionMadmin.php">Gerer les Admin</a>
          </div>
        </div>
      </li>
