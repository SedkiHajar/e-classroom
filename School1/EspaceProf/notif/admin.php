...
//rangd admi, 2   
 ...
 $query ="INSERT INTO `notifications` (`message`, `status`, `date`,id_profe,id_adm,rang,emetteur,destinataire,rangd) VALUES ('$message', 'unread', CURRENT_TIMESTAMP,$id_prof,$admin,3,'$emetteur','$dest',2)";
