<?php //error_reporting(0); 
 ...
 // if (isset($_POST['insererA']) or isset( $_SESSION['anneeS']) ){
 //      $_SESSION['annee'] = $_POST['anneeS'];
 //      $_SESSION['anneeS'] = $_SESSION['annee'];
        ...
        <form action=" " role="form" method="post" enctype="multipart/form-data">
           ...
           <div class="form-row">  
              ...
              <select class="custom-select" name="anneeS" id="">
                <option value="null">Choisir l'année scolaire</option>
                  <?php
                  //définir la requete
