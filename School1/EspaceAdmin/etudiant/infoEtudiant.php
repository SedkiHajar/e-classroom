...
<?php $CIN=$_GET['CIN'];  //echo $CIN;?>
<?php   $result = $db->query("SELECT * FROM etudiant e join classe c JOIN annees a WHERE CIN='$CIN' and c.id=e.classe and e.anneeS=c.anneeS and a.id=e.anneeS  ");
                        ...
                        <form action="uploadEtudParent.php"  role="form" method="post" enctype="multipart/form-data">
                              <div class="row">
                                  ...
                                  <div class="col-md-6">
                                      <div class="profile-head">
                                                  <h2 class=" font-weight-bold text-info  shadow  titre">
                                                    <input class="form-control" name="nom" value="<?php echo $row['nomE']?> ">
                                          ...
                                          <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                                      <div class="form-row">
                                                        ...
                                                        <div class="form-row">
                                                          ...
                                                          <div class="col-md-6">
                                                              <p>   <input class="form-control" type="text" name="cin" value=" <?php echo $row['CIN']; ?> ">  </p>
                                                          </div>
                                                        </div>  
                                                        ...
                                                        <div class="form-row">
                                                          <div class="col-md-6">
                                                           ...
                                                           <div class="col-md-6">
                                                                <p>
                                                               <input class="form-control" type="text" name="classe" value=" <?php echo $row['nom']; ?> ">  </p> 
                                                          </div> 
                                                     </div>
                                                ...
                                                <?php while($row1 = $result1->fetch_assoc()){?> 
                                                          ...
                                                          <div class="col-md-6">  
                                                             <select class="custom-select" name="anneeS" id="">
                                                               <option selected value="<?php echo $row['id']; ?>" ><?php echo $row1['nomA']; ?></option><?php } ?>
                                                              <?php
