...
<fieldset>
  <legend>Message <?= lang('tto') .' '.ucwords($nomet).' '.ucwords($prenom)  ?></legend>
    <form class="form-qst" method="post" action="traitAnnonce.php?do=Etu&CIN=<?=$CIN; ?>&id_anneeS=<?=$idA; ?>">
      <ul>
      ...
      <li>
        ...
        <input class="btn btn-primary btn-sm " type="submit" name="etuen" value="<?= lang('sent')?>">
      </li>
