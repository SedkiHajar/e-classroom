    ...
    <div class="row">
       <!--  <div class="" style="text-align: left;padding-left: 10px; margin-top:10px; " > -->
         <?php  //echo "<b>Email du professeur :<br> $email</b>";
          $body="Voici Le site pour se connecter à l'espace professeur: https://besteduk.com/"."\r\n";
          $body.="Le login: ".$email."\r\n"."Le password: ".$mdp;
        ...
        <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
            ...
            <div class="card card-signin my-5">
                ...
                <div class="card-body">
                    ...
                    <form action="email.php?CIN=<?=$CIN; ?>" method="post" class="form-signin">
                        ...
                        <div class="form-label-group">
                            <label for="inputEmail">A(Email professeur) <span style="color: #FF0000">*</span></label>
