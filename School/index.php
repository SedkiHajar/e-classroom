    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/School/EspaceMasterAdmin/login.php">Master ADMIN</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/School/EspaceAdmin/login.php">ADMIN</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/School/EspaceProf/login.php">PROFESSEUR</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/School/EspaceEtudiant/login.php">ETUDIANT</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/School/EspaceParent/login.php">PARENT</a>
          </li>
    ...
    <div class="container h-100">
      <div class="row h-100 align-items-center">
        <div class="col-lg-12">
          ...
          <p class="lead mb-5 text-white-50">Plus besoin de se déplacer dans un centre de formation ou de faire venir un élève à l'école… 
